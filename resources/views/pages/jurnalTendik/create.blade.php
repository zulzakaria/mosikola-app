    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                ...
                @if ($config->lampau == 1)
                    <a href="/jurnal/tendik/lampau" class="btn btn-md btn-danger">Jurnal Kegiatan Lampau</a>
                @endif
            ...
            <div class="row g-5">
                <div class="col-md-12 col-lg-12">
                    ...
                    @endif
                    <form class="needs-validation" action="/jurnal/tendik/store" method="post" name="frmImage"
