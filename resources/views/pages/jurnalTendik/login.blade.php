                    ...
                    <div class="card mb-3">
                        <div class="row g-0 d-flex align-items-center">
                            <div class="col-lg-4 d-none d-lg-flex">
                                <img src="{{ asset('/img/login2.jpg') }}" alt="foto sekolah"
                                    class="w-100 rounded-t-5 rounded-tr-lg-0 rounded-bl-lg-5" />
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body py-5 px-md-5">
                                    <h3 class="text-center"><strong>{{ $app->shortName }}</strong></h3>
                                    <h3 class="text-center">Jurnal Kegiatan Tenaga Kependidikan</h3>
                                    ...
                                    @endif
                                    <form action="/jurnal/tendik/cekLogin" method="post">
                                        @csrf
                                        <!-- Email input -->
